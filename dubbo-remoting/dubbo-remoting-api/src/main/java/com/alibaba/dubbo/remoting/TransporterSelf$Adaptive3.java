...
public class TransporterSelf$Adaptive3 implements com.alibaba.dubbo.remoting.TransporterSelf {
    public com.alibaba.dubbo.remoting.Client connect(com.alibaba.dubbo.common.URL arg0, com.alibaba.dubbo.remoting.ChannelHandler arg1, com.alibaba.dubbo.rpc.Invocation arg2)
    ...
    public com.alibaba.dubbo.remoting.Server testUrl(com.alibaba.dubbo.common.Node arg0) {
        ...
        if (arg0.getUrl() == null)
            throw new IllegalArgumentException("com.alibaba.dubbo.common.Node argument getUrl() == null");com.alibaba.dubbo.common.URL url = arg0.getUrl();
        String extName = url.getParameter("nettySelf", url.getParameter("minaSelf", url.getParameter("grizzlySelf", "nettySelf")));
        if(extName == null)
            throw new IllegalStateException("Fail to get extension(com.alibaba.dubbo.remoting.TransporterSelf) name from url(" + url.toString() + ") use keys([nettySelf, minaSelf, grizzlySelf])");
        com.alibaba.dubbo.remoting.TransporterSelf extension =
                (com.alibaba.dubbo.remoting.TransporterSelf)ExtensionLoader.getExtensionLoader(com.alibaba.dubbo.remoting.TransporterSelf.class).getExtension(extName);
