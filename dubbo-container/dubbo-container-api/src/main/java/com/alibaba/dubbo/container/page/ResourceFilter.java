...
public class ResourceFilter implements Filter { //资源过滤
    ...
    public void init(FilterConfig filterConfig) throws ServletException { //history-h2 待调试
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        long since = request.getDateHeader("If-Modified-Since"); //history-h2 request与response中的DateHeader为啥不一样？
