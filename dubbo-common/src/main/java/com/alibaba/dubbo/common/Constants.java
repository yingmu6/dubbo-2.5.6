...
public class Constants {
    ...
    public static final String DEFAULT_CATEGORY = PROVIDERS_CATEGORY; // 默认注册中心中节点分类
    ...
    public static final String DEFAULT_REMOTING_SERIALIZATION = "hessian2"; //默认的序列化方式
    ...
    public static final String ANYHOST_KEY = "anyhost"; //history-v1 什么事任意主机？
